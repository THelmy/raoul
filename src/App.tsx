...
import { Instagram, Mail, ArrowRight, Dumbbell, Calculator, Users, Star, Menu, X, CheckCircle2, MessageCircle, Activity, Ban } from 'lucide-react';
  ...
  const createEmailLink = (type: string) => {
    ...
    switch (type) {
      case 'journey':
        ...
        body = `Hi Raoul, 
        I\'m interested in starting my fitness journey with you. I would like to learn more about your training programs.
      ...
      case 'custom-training':
        ...
        body = `Hi Raoul,
        I\'m interested in getting a custom training program. I would like to learn more about how you can help me achieve my fitness goals.
      ...
      case 'nutrition':
        ...
        body = `Hi Raoul,
        I would like to request a nutrition calculation. Here are my details:
...
Regards,`;
      ...
      case 'online-training':
        ...
        body = `Hi Raoul,
        I\'m interested in your online training program. I would like to learn more about how it works and how you can help me achieve my fitness goals.
        ...
        break;
      case 'starter':
        subject = 'Interest in the BASIC PLAN';
        body = `Hi Raoul,
        I\'m interested in your BASIC Plan (€49/month). I would like to get started with the program.
        ...
        break;
      case 'transform':
        subject = 'Interest in the MID-TIER Plan';
        body = `Hi Raoul,
        I\'m interested in your MID-TIER Plan (€99/month). I would like to get started with the program.
        ...
        break;
      case 'elite':
        subject = 'Interest in the PREMIUM Plan';
        body = `Hi Raoul,
        I\'m interested in your PREMIUM Plan (€179/month). I would like to get started with the program.
                    ...
                    {[
                      {
                        ...
                        features: [
                          "Pre-made 4-8 week training program (based on your goal)",
                          "Suitable for home or gym training",
                          "Minimal customization (only small adjustments based on experience level)",
                          "One-time email support for initial questions"
                        ],
                        exclusions: [
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                  ...
                  <div className="text-zinc-400 text-sm">
                    © {new Date().getFullYear()} Fit Protocol. All rights reserved.
                  </div>
                </div>
              </div>
            </footer>
